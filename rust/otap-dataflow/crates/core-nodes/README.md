...
| [`exporter:series_parquet`](src/exporters/series_parquet/README.md) | `series_parquet` | experimental | Writes logs and metrics as series and values Parquet datasets with durable acknowledgements. |
