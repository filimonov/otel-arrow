...
**Source:** docs/superpowers/umbrella-review-2026-09-23.md (numbers below are its item numbers). **Order:** after Task 3f (it edits token.rs, worker.rs and mod.rs, which 3f restructures) and before Task 5a. Every fix starts with a regression test that fails before it.
